...
- 组织身份事实级证据覆盖率为 100%；事件存在覆盖率经三批补证合并后为 18.9%（28/148，2026-08-21 第三批按事件级审核决策合并、人工授权状态：已追认（追认日期 2026-08-27）后口径；两批重复事件条目已按日记与通说合并，事件总数由 150 降至 148）；人物生卒年和角色仍缺少事实级证据。覆盖率报告自 2026-08-27 起区分三种事件口径：已挂接 28/148、直接支持 22/148、已确认 23/148，三者语义互不替代。
