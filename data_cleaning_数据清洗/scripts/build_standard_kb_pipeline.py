...
INPUT_DIR = PROJECT_ROOT / "input_输入"
RAW_EXCEL_DIR = INPUT_DIR / "raw_excel_原始表格"
RAW_TEXT_DIR = INPUT_DIR / "raw_texts_原始文本"
OUTPUT_DIR = PROJECT_ROOT / "output_输出结果"
CLEANED_DIR = OUTPUT_DIR / "cleaned_data_清洗数据"
KB_DIR = OUTPUT_DIR / "kb_data_知识库数据"
LOG_DIR = OUTPUT_DIR / "logs_日志"
REPORT_DIR = OUTPUT_DIR / "reports_报告"
ARCHIVE_DIR = PROJECT_ROOT / "archive_归档" / "old_outputs_旧输出"
...
CLEAN_SCRIPT = PROJECT_ROOT / "data_cleaning_数据清洗" / "scripts" / "clean_zolian_excel.py"
...
def write_reports(
    *,
    ...
    validation_lines.extend(["", "## output 文件清单"])
