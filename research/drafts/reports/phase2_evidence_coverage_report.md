...
| --- | ---: | ---: | ---: |
| 组织身份 | 150 | 150 | 100.0% |
| 事件存在·已挂接事实证据覆盖（存在任一事实证据即计入） | 28 | 148 | 18.9% |
| 事件存在·直接支持覆盖（evidence_support=support，不论裁决与复核状态） | 22 | 148 | 14.9% |
| 事件存在·已确认覆盖（reviewed 且为 support 或已裁决 conflict［adjudication_status=resolved_by_event_correction］） | 23 | 148 | 15.5% |
| 人物出生年 | 0 | 162 | 0.0% |
| 人物逝世年 | 0 | 162 | 0.0% |
| 人物角色 | 0 | 162 | 0.0% |
...
- 三口径速览：已挂接 28/148；直接支持 22/148；已确认 23/148。
